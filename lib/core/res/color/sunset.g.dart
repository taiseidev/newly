...
const lightSunsetColorScheme = ColorScheme(
  brightness: Brightness.light,
  primary: Color(0xFFB32824),
  ...
  surfaceTint: Color(0xFFB32824),
  outlineVariant: Color(0xFFD8C2BF),
  scrim: Color(0xFF000000),
);

const darkSunsetColorScheme = ColorScheme(
  brightness: Brightness.dark,
  primary: Color(0xFFFFB4AB),
  onPrimary: Color(0xFF690006),
  primaryContainer: Color(0xFF900B10),
  ...
  inversePrimary: Color(0xFFB32824),
  shadow: Color(0xFF000000),
